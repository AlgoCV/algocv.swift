...
/// Frequency-domain representation of an `Image4Bit`, stored as two row-major
/// `Int32` planes (real and imaginary parts), matching ImPro's `Freq16`
/// layout. Each plane has `cols * rows` complex coefficients — the 4-bit
/// label refers to the source image, not the spectrum element width.
public struct Spectrum4Bit: Sendable, Equatable {
